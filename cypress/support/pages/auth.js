class Auth{
    ...
    // you can put more than one class in a file , and none of them have any 
...
class Locators{
    ...
    get userName() {
       ...
       // defining custom timeout  for a specific element
       // this timeout is a dynamic wait ,  when it finds it moves on 
    }
